...
export const metadata: Metadata = {
  ...
  description:
    "Descubra experiências de viagem personalizadas feitas especialmente para você. De destinos incríveis a estadias exclusivas, criamos sua jornada perfeita.",
  keywords: [
    "agência de viagens",
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="pt-BR">
      <AnalyticsProvider />
      <body
        className={`${comfortaa.variable} ${baloo.variable} font-comfortaa antialiased bg-white text-gray-900`}
      >
        <WizardProvider>
          <TopMenu />
