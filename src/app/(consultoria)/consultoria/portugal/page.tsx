    ...
    <div className="flex flex-col">
      ...
      <section className="relative h-screen flex items-center">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="/assets/consultoria/portugal/hero.jpg"
            alt="Portugal - Terra de história e sabores"
            fill
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1">
              <div className="rounded-xl overflow-hidden shadow-2xl">
                <MuxVideoPlayer 
                  ...
                  title="Portugal - Terra de História e Sabores"
                  isMuted={false}
                  loop={false}
                />
              </div>
            ...
            <div className="order-1 lg:order-2">
              <h1 className="font-baloo text-4xl md:text-6xl font-bold mb-6 text-white">
                Sua viagem para <span className="text-accent-500">Portugal</span> dos sonhos
              </h1>
              <p className="text-white/90 font-comfortaa text-xl mb-8">
                Descubra cidades históricas, praias douradas, vinhos premiados e a hospitalidade única de Portugal.
              </p>
              <Button 
                onClick={() => setIsLeadFlowModalOpen(true)}
                event="pre_agendar"
                eventOptions={{
                  source: 'Hero Section - Portugal'
                }}
        ...
        <div className="w-full md:w-[80%] mx-auto px-4 md:px-0">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-[600px]">
              <Image
                src="/assets/consultoria/portugal/planning-challenges.jpg"
                alt="Pessoa confusa com muitas opções de viagem em Portugal"
                fill
            ...
            <div>
              <h2 className="font-baloo text-3xl md:text-4xl font-bold mb-6 text-secondary-900">
                Planejar uma viagem para Portugal pode ser <span className="text-accent-500">desafiador</span>
              </h2>
              <div className="space-y-6 text-secondary-600 font-comfortaa text-lg mb-8">
                <p>
                  Com tantas cidades históricas, regiões vinícolas e praias incríveis, é fácil se sentir sobrecarregado. Qual região visitar primeiro? Como organizar os traslados? Onde encontrar as melhores experiências autênticas?
                </p>
                <p>
                  A pesquisa pode levar semanas, e mesmo assim você pode acabar perdendo experiências únicas ou escolhendo opções que não são ideais para o seu perfil de viajante.
                </p>
                <p>
                  <span className="text-accent-500 font-bold">Nós resolvemos isso para você.</span> Nossa equipe de especialistas conhece cada detalhe de Portugal e vai criar uma viagem personalizada que supera suas expectativas, sem que você precise se preocupar com a complexidade do planejamento.
                </p>
              </div>
              <Button 
                onClick={() => setIsLeadFlowModalOpen(true)}
                event="pre_agendar"
                eventOptions={{
                  source: 'Planning Challenges Section - Portugal'
                }}
                className="inline-block font-baloo bg-accent-500 text-white px-8 py-3 rounded-full text-lg font-semibold hover:bg-accent-600 transition-all"
              >
                Conversar com um especialista
        ...
        <div className="w-full md:w-[80%] mx-auto px-4 md:px-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="group relative overflow-hidden rounded-xl shadow-lg">
              <div className="relative h-[400px]">
                <Image
                  src="/assets/consultoria/portugal/historia.jpg"
                  alt="História e cultura de Portugal"
                  fill
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent duration-300 flex flex-col justify-end p-6">
                  ...
                  <p className="text-white/90 font-comfortaa text-lg">
                    Castelos medievais, centros históricos e tradições que atravessam séculos.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-xl shadow-lg">
              <div className="relative h-[400px]">
                <Image
                  src="/assets/consultoria/portugal/gastronomia.jpg"
                  alt="Gastronomia e vinhos de Portugal"
                  fill
                  className="object-cover transition-transform duration-500 group-hover:scale-110"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent duration-300 flex flex-col justify-end p-6">
                  ...
                  <p className="text-white/90 font-comfortaa text-lg">
                    Experiências gastronômicas autênticas, vinhos premiados e sabores únicos em cada região.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-xl shadow-lg">
              <div className="relative h-[400px]">
                <Image
                  src="/assets/consultoria/portugal/praias.jpg"
                  alt="Praias de Portugal"
                  fill
                  className="object-cover transition-transform duration-500 group-hover:scale-110"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent duration-300 flex flex-col justify-end p-6">
                  ...
                  <p className="text-white/90 font-comfortaa text-lg">
                    Praias douradas do Algarve, ilhas paradisíacas e paisagens naturais de tirar o fôlego.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="text-center">
            <Button 
              ...
              event="pre_agendar"
              eventOptions={{
                source: 'Unique Moments Section - Portugal'
              }}
              className="inline-block font-baloo bg-accent-500 text-white px-8 py-3 rounded-full text-lg font-semibold hover:bg-accent-600 transition-all"
            >
              Conversar com um especialista
      ...
      {/* FAQ Section */}
      <FAQTripPlanningSection source="Portugal" />
      ...
      <section className="py-24 bg-secondary-900 text-white">
        <div className="w-full md:w-[80%] mx-auto px-4 md:px-0 text-center">
          ...
          <Button
            ...
            event="pre_agendar"
            eventOptions={{
              source: 'Final CTA Section - Portugal'
            }}
      ...
      {/* Newsletter Section */}
      <NewsletterSection source="Portugal" />

      {/* Lead Flow Modal */}
      <LeadFlowModal
        isOpen={isLeadFlowModalOpen}
        onClose={() => setIsLeadFlowModalOpen(false)}
        destinations={portugueseDestinations}
        source="Portugal"
      />
    </div>
  )
