import CruiseExperience from "@/components/cruises/CruiseContent";
...
export default function CruiseOverview({ params }: Props) {
  ...
  return <CruiseExperience experience={experience} />;
}
