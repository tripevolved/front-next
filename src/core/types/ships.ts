...
export const exploraI: CruiseShip = {
  name: "Explora I",
  ...
  amenities: [
    ...
    },
    {
      ...
      items: [
        "Crema Café - Café europeu com vista para o mar (Deck 5)",
        "Lobby Bar - Bar central elegante no coração do navio (Deck 4)",
        "Explora Lounge - Lounge principal com 270° de vista oceânica (Deck 11)",
        "Malt Whisky Bar - Bar de whisky premium com walk-in humidor (Deck 11)",
        "Journeys Lounge - O mais espaçoso lounge a bordo (Deck 4)",
        "Astern Lounge - Lounge social abrindo para a Astern Pool (Deck 5)",
        "Astern Pool & Bar - Bar à beira da piscina infinity (Deck 5)",
        "Atoll Pool & Bar - Piscina intimista para relaxamento (Deck 10)",
        "Helios Pool & Bar - Piscina exclusiva para adultos (Deck 12)",
        "Sky Bar On 14 - Bar no ponto mais alto do navio (Deck 14)",
        "The Conservatory Pool & Bar - Lounge coberto com cinema ao ar livre (Deck 11)",
        "Gelateria & Creperie - Autênticas delícias francesas e italianas (Deck 11)",
      ],
    },
    {
      category: "Compras",
      items: [
        "Boutique de luxo",
        "Rolex Store - Loja oficial Rolex a bordo",
