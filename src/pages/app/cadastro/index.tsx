import { AuthRegisterForm, AuthSection, PageApp } from "@/features";
  ...
  return (
    <AuthSection heading="O cadastro ainda não está disponível para o público geral">
      <Card elevation="md" className="auth-section__card">
        <EmptyState
          text={
            "Atualmente, nosso cadastro está disponível somente para as pessoas que participam de nossa lista de espera. Você pode acessá-la através do nosso pré-cadastro e, em breve, vamos conversar com você para liberar o acesso à plataforma da Trip Evolved."
          }
        />
      </Card>
      <Button variant="primary" href="/pre-cadastro">
