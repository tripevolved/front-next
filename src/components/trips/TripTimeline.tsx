    ...
    return (
      <>
        <button
          ...
          className="flex flex-col items-center justify-center min-h-[120px] w-full rounded-xl border-2 border-dashed border-accent-400 bg-accent-50 hover:bg-accent-100 transition-colors py-8 px-4 cursor-pointer"
          title={blockedMessage}
        >
          <div className="flex-shrink-0 w-12 h-12 rounded-full bg-accent-200 flex items-center justify-center mb-2">
            <svg className="w-6 h-6 text-accent-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
            </svg>
          </div>
          <span className="font-baloo font-semibold text-secondary-900 text-center text-sm">
            Assinar o Círculo Evolved
          </span>
          <p className="mt-2 text-xs text-secondary-600 text-center leading-snug max-w-xs">{blockedMessage}</p>
        </button>
