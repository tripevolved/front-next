...
const DEFAULT_SUBTITLE = 'Na próxima etapa, vamos recomendar destinos curados para vocês.'
...
export function IntentPreviewScreen({
  intentSummary,
  isLoading,
  onContinue,
  compact = false,
  ...
  return (
    <div className={`flex flex-col flex-1 bg-white ${compact ? 'min-h-0' : 'min-h-screen'}`}>
      <div className="flex-1 min-h-0 overflow-y-auto p-6 max-w-2xl mx-auto w-full flex flex-col justify-center gap-8">
        ...
        <p className="font-comfortaa text-sm text-secondary-500 text-center">{subtitle}</p>
