...
export function ShareModal({ isOpen, onClose, link, message }: ShareModalProps) {
  ...
  const handleShareWhatsApp = () => {
    const shareMessage = `${message} ${link}`
    window.open(`https://wa.me/?text=${encodeURIComponent(shareMessage)}`, '_blank')
  }

  const handleShareInstagram = () => {
    // For Instagram, we can only open the app as direct sharing requires Instagram API
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
      <div className="bg-white rounded-2xl p-6 max-w-sm w-full relative">
        ...
        <h2 className="text-xl font-baloo font-bold text-secondary-900 mb-4">
          Compartilhar
        </h2>
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-center gap-4">
            ...
            >
              ...
              <span className="text-xs font-comfortaa text-secondary-700">Instagram</span>
            </button>
          </div>
        </div>
      </div>
