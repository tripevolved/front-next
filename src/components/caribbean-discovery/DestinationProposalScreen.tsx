    ...
    <div className={`flex flex-col flex-1 bg-white ${compact ? 'min-h-0' : 'min-h-screen'}`}>
      {compact ? (
        <div className="shrink-0 border-b border-secondary-200 p-6 text-center">
          <p className="font-comfortaa text-xs text-secondary-500">Destinos curados para vocês</p>
          <h1 className="font-baloo text-2xl font-bold text-secondary-900 mt-1">Para onde o Caribe chama?</h1>
        </div>
      ) : (
        <div className="relative h-48 md:h-56 shrink-0">
          <Image src="/assets/consultoria/caribe/hero.jpg" alt="Caribe" fill className="object-cover" />
          <div className="absolute inset-0 bg-black/50" />
          <div className="absolute inset-0 flex flex-col justify-end p-6 text-white">
            <p className="font-comfortaa text-sm text-white/80">Destinos curados para vocês</p>
            <h1 className="font-baloo text-2xl md:text-3xl font-bold">Para onde o Caribe chama?</h1>
          </div>
        </div>
      )}
