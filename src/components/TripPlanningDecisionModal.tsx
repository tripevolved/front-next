    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto relative flex flex-col">
        <div className="flex justify-between items-center p-6">
          {isLoading ? (
            <div className="animate-pulse border-gray-300 rounded-xl w-80 h-7 bg-gray-200" />
          ) : (
          ...
          {isLoading ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-500 mb-4">
                Não conseguimos pegar as informações do seu destino, mas você ainda pode planejar
                sua viagem
              </p>
            </div>
          )}
            ...
            {hasTraveler ? (
              <div className="flex-1">
                <WhatsAppDirectButton
                  message={`Olá! Gostaria de falar sobre o destino ${
                    destination?.title || "selecionado"
                  }.`}
                  variant="secondary"
                  className="w-full"
                >
              ...
              <div className="flex-1">
                <button
                  ...
                  className="w-full bg-white text-primary-600 border border-primary-600 py-2 rounded-full font-medium hover:bg-primary-50 transition-colors flex items-center justify-center"
                >
