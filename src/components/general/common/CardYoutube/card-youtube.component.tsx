...
const CardYoutube = ({ children, className, style, videoId, ...props }: CardYoutubeProps) => {
  ...
  return (
    <Card elevation={CardElevations.Low} className={cn} {...props} style={computedStyle}>
      <div className="card-youtube__thumbnail">
        <ToggleButton className="card-youtube__play-button" iconName="play" onClick={handleClick} />
      </div>
      <YouTube
        ref={video}
