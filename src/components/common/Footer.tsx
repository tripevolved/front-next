        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/80 text-xs">
              Tecnologia e curadoria especializada unidas para proporcionar experiências de viagem exclusivas
            </p>
          </div>

          {/* Column 2: Contact */}
          <div>
            <h3 className="font-baloo text-base font-semibold mb-4 text-accent-500">Fale conosco</h3>
            <ul className="space-y-1.5">
              <li>
                <a 
                  href="https://api.whatsapp.com/send?phone=5512991694499&text=Ol%C3%A1%2C%20eu%20gostaria%20de%20planejar%20minha%20pr%C3%B3xima%20viagem!"
                  target="_blank"
          ...
          <div>
            ...
            <ul className="space-y-1.5">
              ...
              <li>
                <Link href="/politica-de-cookies" className="text-white/80 hover:text-white transition-colors text-sm">
                  Política de cookies
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-1.5">
              <li>
                <Link href="/pre-cadastro" className="text-white/80 hover:text-white transition-colors text-sm">
                  Participe da lista de espera
                </Link>
              </li>
              <li>
                <Link href="/perfil" className="text-white/80 hover:text-white transition-colors text-sm">
          ...
          <div>
            <h3 className="font-baloo text-base font-semibold mb-4 text-accent-500">Siga nas redes</h3>
