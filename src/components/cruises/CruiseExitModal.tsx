...
export function CruiseExitModal({ isOpen, onClose, experienceTitle }: ExperienceExitModalProps) {
      ...
      >
        ...
        >
          ...
          <div className="bg-primary-50 rounded-xl p-6 mb-6">
            <h3 className="font-baloo font-semibold text-primary-700 mb-4 text-left">
              Converse com um de nossos especialistas para planejar a sua viagem. Vamos garantir que
              cada detalhe seja pensado para o que você quer viver.
            </h3>
            <div className="space-y-3 text-sm text-primary-600 text-left">
