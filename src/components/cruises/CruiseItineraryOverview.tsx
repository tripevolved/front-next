  ...
  return (
    <>
      <section className="flex flex-col gap-4">
        <section className="p-10 bg-secondary-500">
          <div className="flex flex-col md:flex-row items-center gap-4 w-full max-w-[80%] mx-auto">
            <div className="w-full max-w-4xl">
              <CruiseImageCarousel />
            </div>
            <div className="flex flex-col gap-2 h-full font-baloo">
              <h2 className="text-white md:text-lg text-xl font-bold">Explora Journeys</h2>
        ...
        <section className="py-6 px-3 max-w-[80%] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-primary-50 border-2 border-primary-500 rounded-2xl p-6 flex items-center justify-center text-center hover:shadow-lg transition-shadow">
              <span className="text-gray-800 font-baloo font-semibold text-lg">
                Aéreo ida e volta
              </span>
            </div>
            <div className="bg-primary-50 border-2 border-primary-500 rounded-2xl p-6 flex items-center justify-center text-center hover:shadow-lg transition-shadow">
              <span className="text-gray-800 font-baloo font-semibold text-lg">Cruzeiro</span>
            </div>
            <div className="bg-primary-50 border-2 border-primary-500 rounded-2xl p-6 flex items-center justify-center text-center hover:shadow-lg transition-shadow">
              <span className="text-gray-800 font-baloo font-semibold text-lg">
                Hospedagem pré-cruzeiro
              </span>
            </div>
            <div className="bg-primary-50 border-2 border-primary-500 rounded-2xl p-6 flex items-center justify-center text-center hover:shadow-lg transition-shadow">
              <span className="text-gray-800 font-baloo font-semibold text-lg">
                Hospedagem pós-cruzeiro
              </span>
            </div>
          </div>
        </section>
        ...
        <section className="from-primary-600 to-primary-700 bg-gradient-to-br p-10">
          <div className="flex flex-col justify-center gap-3 max-w-[80%] mx-auto">
