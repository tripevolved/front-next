            ...
            >
              <div className="flex flex-col">
                ...
                <div className="p-4 flex flex-col gap-3">
                  ...
                  <button className="inline-flex items-center justify-center w-full gap-2 py-2 px-4 text-center bg-green-500 hover:bg-green-600 rounded-lg text-white transition-colors text-sm font-medium" onClick={handleConsoleLog}>
