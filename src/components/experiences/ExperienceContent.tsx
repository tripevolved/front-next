...
export function ExperienceContent({ experience }: ExperienceContentProps) {
  ...
  // Check if contato=true query parameter exists
  const useWhatsApp = searchParams?.get("contato") === "true";
  ...
  return (
    <div className="min-h-screen" ref={containerRef}>
      ...
      <LeadFlowModal
        ...
        destinations={["Caribe", "Europa", "Ásia", "América do Sul"]}
        source={`Experiência - ${experience.title}`}
