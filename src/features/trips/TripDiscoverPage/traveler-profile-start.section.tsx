...
export function ProfileStartSection({
  title,
  subtitle,
  onSubmit,
  className,
  children,
  ...props
}: TripDiscoverStartProps) {
  return (
    <SectionBase container="md" className="trip-profile-start">
      <Picture
        alt="Figura de uma pessoa sorridente com as mãos balançando acima da cabeça"
      ...
      <Box className="trip-profile-start__box">
        <Container container={"xs" as any}>
          <Text className="trip-profile-start__text mb-lg" heading={true} size="xl">
            Olá! 👋
          </Text>
          <Text>
            {title
