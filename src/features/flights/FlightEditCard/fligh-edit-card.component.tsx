import { Card, Button, Modal, Heading, Caption, Icon } from "mars-ds";
...
export function FlightEditCard({
          ...
          <React.Fragment key=".0">
            <div className="mb-lg">
              ...
              >
                ...
                >
                  {arrivalDestination.origin.description}
                </span>{" "}
            ...
            <div>
              {flight.flights.map((flight: any, index: number) => (
                <div
                  key={flight.number}
                  style={{
                    borderRadius: "1rem",
                    ...
                    >
                      <div style={{ flex: 1 }}>
                        <h3 style={{ fontSize: "1.5rem", fontWeight: 600, color: "#0AB9AD" }}>
                          {extractCityName(departureOrigin.origin.description)}
                        </h3>
                        <div
                          style={{
                            display: "flex",
  ...
  return (
    <>
      <Card
        onClick={() => handleSelectedFlight(flight.number)}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span>{arrivalDestination.destination.description}</span>
                </div>
              </div>
            </div>
