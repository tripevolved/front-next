...
export interface BusinessProposalDocumentDataBlocksItem {
  ...
  type: prismicT.SelectField<
    "Text" | "Location" | "Transfer" | "Accommodation" | "Restaurant" | "Attraction"
  >;
  /**
   ...
   *
   */
  period: prismicT.SelectField<
    "manhã" | "meio-dia" | "tarde" | "janta" | "noite" | "café da manhã"
  >;
  /**
...
export type BusinessProposalDocument<Lang extends string = string> =
  prismicT.PrismicDocumentWithUID<Simplify<BusinessProposalDocumentData>, "businessProposal", Lang>;
